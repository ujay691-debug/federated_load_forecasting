"""AND-style weather-aware additive AE-shift net-load forecasting baseline.

Examples:
    python weather_aware_additive_ae_shift_ste_weather_baseline_main.py --client-id 1
    python weather_aware_additive_ae_shift_ste_weather_baseline_main.py --lambda-ste 1.0 --lambda-next 1.0 --alpha-ste 0.1
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--output-root",
        default=os.path.join("runs", "weather_aware_additive_ae_shift_ste_weather_baseline"),
...
def train_one_client(client_id: int, csv_path: str, args, base_cfg: WeatherAwareAEShiftExperimentConfig):
    ...
    config_payload = {
        ...
        "input_policy": {
            ...
            "model_output": "Shape + WeatherResidual",
    ...
    print("=" * 100)
    print(f"Weather-aware AND-style AE-shift baseline training | Shape + Weather Residual | {client_name}")
